...
const HeroSection = () => {
    ...
    return (
        <div id="hero" className="flex flex-col lg:flex-row items-center justify-between gap-4 px-5 lg:px-8 xl:px-[8%]">
            <div className="flex flex-col mt-24">
                ...
                <div className="flex items-center gap-4 mt-4 ">
                    ...
                    <a href="protfolio-cv.pdf" download>
                        <ShinyButton>
        ...
        <OrbitingCircles iconSize={30} radius={100} reverse speed={2}>
          ...
          <Icons.nextJS />
                ...
                {/* <OrbitingCircles className="relative h-[500px] w-full overflow-hidden">
                    <FaReact />
                    <SiTypescript />
                    <RiNextjsFill />
                </OrbitingCircles>
